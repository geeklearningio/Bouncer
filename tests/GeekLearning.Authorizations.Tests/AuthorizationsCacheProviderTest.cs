namespace GeekLearning.Authorizations.Tests
{
    ...
    {
        [Fact]
        public async Task GetScopesLebel_ShouldBeOk()
        {
            using (var authorizationsFixture = new AuthorizationsFixture())
            {
                ...
                var cachedScopes = await authorizationsCacheProvider.GetScopesAsync();

                Assert.Equal(0, cachedScopes[scope1Entity.Entity.Id].Level);
                Assert.Equal(1, cachedScopes[scope2Entity.Entity.Id].Level);
                Assert.Equal(2, cachedScopes[scope3Entity.Entity.Id].Level);
                Assert.Equal(1, cachedScopes[scope4Entity.Entity.Id].Level);
                Assert.Equal(2, cachedScopes[scope5Entity.Entity.Id].Level);
                Assert.Equal(3, cachedScopes[scope6Entity.Entity.Id].Level);
                Assert.Equal(4, cachedScopes[scope7Entity.Entity.Id].Level);
            }
        }
